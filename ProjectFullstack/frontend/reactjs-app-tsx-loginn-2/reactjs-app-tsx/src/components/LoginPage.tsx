...
const BackgroundImage =
    'https://newwave.vn/wp-content/uploads/2022/11/teamlead-scaled.jpg';
const Logo =
    'https://newwave.vn/wp-content/themes/nwstheme/assets/images/logo-nws.png';
        ...
        >
            ...
            <div className="login-card shadow-lg p-4 bg-white rounded position-relative">
                <div className="text-center mb-3">
                    <img src={Logo} alt="logo" style={{ width: 230, height: 60 }} />
                </div>
